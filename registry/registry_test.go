...
func TestRegister(t *testing.T) {
	...
	req.Method = "register"
	req.EntityID = dvotetypes.HexBytes("12345123451234")
	...
	req2.EntityID = dvotetypes.HexBytes("12345123451234")
	...
	req4.EntityID, err = hex.DecodeString("12345123451234")
	if err != nil {
	...
	req9.EntityID = dvotetypes.HexBytes("12345123451234")
	...
	// req10.EntityID = dvotetypes.HexBytes("12345123451234")
	...
	// req11.EntityID = dvotetypes.HexBytes("12345123451234")
...
func TestStatus(t *testing.T) {
	...
	req.Method = "register"
	req.EntityID = dvotetypes.HexBytes("12345123451234")
	req.PubKey = dvotetypes.HexBytes("12345123451234")
	req.MemberInfo = &types.MemberInfo{
		Email: "info@vocdoni.io",
	}
	...
	// req6.EntityID = dvotetypes.HexBytes("12345123451234")
